    ...
    <div className="w-11/12 mx-auto py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-12 md:gap-4 lg:gap-16">
          ...
          <p className="flex items-center gap-1 text-[14px] md:text-[16px] lg:text-[20px] cursor-pointer hover:text-green-600"><BsFire className="text-[#3BB77E]" /><span>Hot Deals</span></p>
        ...
        <div className="flex items-center gap-2 md:gap-4 lg:gap-6 px-2 ">
          ...
          <div className="hidden md:flex overflow-hidden gap-4 md:gap-4 lg:gap-10 ">
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">About</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Shop</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Mega Menu</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Vendors</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Blogs</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Pages</p>
            <p className="text-[14px] md:text-[16px] lg:text-[20px]  cursor-pointer hover:text-green-600">Contact</p>
          </div>
        ...
        <button className="bg-[#3BB77E] text-sm md:text-lg lg:text-xl text-white px-2 md:px-3 lg:px-4 py-1 lg:py-1.5 rounded-md">Log In</button>
